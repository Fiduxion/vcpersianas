...
const About = () => {
    return <div className="">
        ...
        <span className="font-bold text-orange-500">V&C Persianas</span> es tu solución completa en Rosario y alrededores para la instalación, reparación y atención inmediata de persianas, 
        ...
        un servicio de calidad adaptado a tus necesidades. Confía en <span className="font-bold text-orange-500">V&C Persianas</span> para obtener soluciones profesionales que 
