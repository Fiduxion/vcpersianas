...
const About = () => {
    return <div className="">
        ...
        <p className="text-slate-200 text-justify text-xl md:w-3/5 m-auto">
        <span className="font-bold text-orange-500">Persianas 24 horas</span> es tu solución completa en Rosario y alrededores para la instalación, reparación y atención inmediata de persianas, 
        ...
        un servicio de calidad adaptado a tus necesidades. Confía en <span className="font-bold text-orange-500">Persianas 24 horas</span> para obtener soluciones profesionales que 
